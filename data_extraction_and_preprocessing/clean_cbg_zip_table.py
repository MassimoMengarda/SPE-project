...
def main(input_filepath, zip_in_metro_area_filepath, output_filepath):
    zip_cbg_df = read_csv(input_filepath, converters={"zip": str, "cbg": str})
...
if __name__ == "__main__":
    ...
    main(input_filepath, zip_in_metro_area_filepath, output_filepath)
