...
def main(input_dir, info_dir, output_filepath):
...
if __name__ == "__main__":
    ...
    parser.add_argument("info_directory", type=str, help="the directory where the cbg matrix is stored")
    ...
    main(input_dir, info_dir, output_filepath)
