...
def generate_graph(io_to_category_filepath, countermeasure_results_dirs, countermeasure_names, saving_filepath, colormap):
...
if __name__ == "__main__":
    ...
    output_directory = "/home/matteo/uniTN/simulation_performance/project-data/graph-color-results"
    ...
    for colormap_name in colormap_names:
        generate_graph(io_to_category_filepath, countermeasure_results_dirs, countermeasure_names, os.path.join(output_directory, colormap_name + ".jpg"), colormap_name)